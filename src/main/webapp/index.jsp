...
<head>
  ...
  <link rel="stylesheet" href="${path}/assets/css/green.css">
          ...
          <div class="form-bottom">
            <form role="form" action="<%=request.getContextPath()%>/login" method="post" class="login-form">
              <div class="form-group">
                ...
                <input type="text" name="name" placeholder="用户名或注册的邮箱" class="form-username form-control" id="form-username">
              </div>
              <div class="form-group">
...
<script src="${path}/assets/js/jquery-1.11.1.min.js" type="text/javascript"></script>
<script src="${path}/assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${path}/assets/js/bootstrapValidator.js" type="text/javascript"></script>
<script src="${path}/assets/js/jquery.backstretch.min.js"></script>
<script src="${path}/assets/js/scripts.js"></script>
<script src="${path}/assets/js/icheck.min.js"></script>
